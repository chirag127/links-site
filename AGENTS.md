# oriz-links-site — agent guide

Curated dev-sites field guide (links.oriz.in)
...
- Deploy: `astro build && wrangler pages deploy dist --project-name oriz-links-site --branch main --commit-dirty=true`.
